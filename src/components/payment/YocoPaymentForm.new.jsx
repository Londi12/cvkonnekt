  ...
  const handlePayment = async (event) => {
    ...
    try {
      ...
      const result = await yocoSDK.createToken({
        ...
        name: `CVKonnekt ${planName} Subscription`,
    ...
    <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="font-semibold">{planName} Subscription</span>
        </div>
        <div className="flex justify-between items-center mb-2">
          <span className="text-gray-600">Billing:</span>
          <span className="text-sm text-gray-600 capitalize">{billingCycle} billing</span>
        </div>
        <div className="flex justify-between items-center mb-2">
